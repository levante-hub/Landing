    ...
    <div className="w-full h-full flex items-center justify-center p-4">
      ...
      >
        ...
        <g transform="translate(25, 65)">
          <path d="M0 8h16M8 0v16" stroke="#64748B" strokeWidth="2" strokeLinecap="round" />
        </g>
        ...
        <g transform="translate(20, 100)">
          ...
          <g transform="translate(0, 0)">
            <path d="M4 12v4a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2v-4M16 6l-4-4-4 4M12 2v10" stroke="#334155" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" transform="translate(0, 2) scale(0.8)" />
          ...
          <g transform="translate(0, 45)">
            <rect 
              ...
              fill={step >= 1 ? "#EAE3D2" : "transparent"} 
              fillOpacity={step >= 1 ? "0.5" : "0"}
              className="transition-colors duration-300 ease-in-out"
            />
            <path d="M4 7V4a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v3M4 7a2 2 0 0 0-2 2v6a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2V9a2 2 0 0 0-2-2M4 7h16M10 11h4" stroke="#334155" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" transform="translate(0, 2) scale(0.8)" />
        ...
        >
          ...
          <g transform="translate(20, 60)">
            ...
            <g transform="translate(0, 0)" className={`transition-opacity duration-200 ease-out ${step >= 3 ? 'opacity-100' : 'opacity-0'}`}>
              <path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z" stroke="#94A3B8" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" transform="scale(1)" />
          ...
          <g transform="translate(20, 300)">
            ...
            <g transform="translate(0, 0)" className={`transition-opacity duration-200 ease-out delay-[120ms] ${step >= 3 ? 'opacity-100' : 'opacity-0'}`}>
              <path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8zM14 2v6h6M16 13H8M16 17H8M10 9H8" stroke="#334155" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
