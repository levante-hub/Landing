    ...
    <div className="w-full h-full flex items-center justify-center p-4">
      ...
      >
        ...
        <g 
          ...
          className={`transition-all duration-700 ${step >= 2 ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-4'}`}
        >
          ...
          <g transform="translate(20, 60)">
            {/* code-review */}
            <g transform="translate(0, 0)" className={`transition-opacity duration-500 ${step >= 3 ? 'opacity-100' : 'opacity-0'}`}>
            ...
            {/* explain-concept */}
            <g transform="translate(0, 65)" className={`transition-opacity duration-500 delay-100 ${step >= 3 ? 'opacity-100' : 'opacity-0'}`}>
              <path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z" stroke="#3B82F6" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" transform="scale(1)" />
            ...
            {/* debug-helper */}
            <g transform="translate(0, 130)" className={`transition-opacity duration-500 delay-200 ${step >= 3 ? 'opacity-100' : 'opacity-0'}`}>
              <path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z" stroke="#3B82F6" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" transform="scale(1)" />
          ...
          <g transform="translate(20, 300)">
            {/* server-config */}
            <g transform="translate(0, 0)" className={`transition-opacity duration-500 delay-300 ${step >= 3 ? 'opacity-100' : 'opacity-0'}`}>
            ...
            {/* system-stats */}
            <g transform="translate(0, 65)" className={`transition-opacity duration-500 delay-400 ${step >= 3 ? 'opacity-100' : 'opacity-0'}`}>
              <path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8zM14 2v6h6M16 13H8M16 17H8M10 9H8" stroke="#111827" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
